...
// import { BroadcasterFrame } from './component';
// import { ExtensionViewType, ExtensionAnchor, ExtensionMode } from '../constants/extension-coordinator';
//
// describe('<BroadcasterFrame />', () => {
//   const setupShallow = setupShallowTest(BroadcasterFrame, () => ({
//     frameId: '0',
...
//   }));
//
//   const setupMount = setupMountTest(BroadcasterFrame, () => ({
//     className: 'view',
//     frameId: '0',
//     extension: ExtensionForTest,
//     type: ExtensionAnchor.Panel,
...
//     };
//
//     const instance = wrapper.instance() as BroadcasterFrame;
//     instance.iframe = mockIframeRef;
//     instance.broadcasterFrameInit();
