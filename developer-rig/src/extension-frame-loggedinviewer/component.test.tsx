...
import { LoggedInViewerFrame } from './component';
import { ExtensionViewType, ExtensionAnchor, ExtensionMode } from '../constants/extension-coordinator';

describe('<LoggedInViewerFrame />', () => {
  const setupShallow = setupShallowTest(LoggedInViewerFrame, () => ({
    frameId: '0',
  ...
  const setupMount = setupMountTest(LoggedInViewerFrame, () => ({
    className: 'view',
    frameId: '0',
    extension: ExtensionForTest,
    type: ExtensionAnchor.Panel,
  ...
  it('onload postMessages data correctly', () => {
    ...
    const instance = wrapper.instance() as LoggedInViewerFrame;
    instance.iframe = mockIframeRef;
    instance.loggedInViewerFrameInit();
