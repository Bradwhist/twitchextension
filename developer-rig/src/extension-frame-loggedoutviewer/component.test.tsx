...
import { LoggedOutViewerFrame } from './component';
import { ExtensionViewType, ExtensionAnchor, ExtensionMode } from '../constants/extension-coordinator';

describe('<LoggedOutViewerFrame />', () => {
  const setupShallow = setupShallowTest(LoggedOutViewerFrame, () => ({
    frameId: '0',
  ...
  const setupMount = setupMountTest(LoggedOutViewerFrame, () => ({
    className: 'view',
    frameId: '0',
    extension: ExtensionForTest,
    type: ExtensionAnchor.Panel,
  ...
  it('onload postMessages data correctly', () => {
    ...
    const instance = wrapper.instance() as LoggedOutViewerFrame;
    instance.iframe = mockIframeRef;
    instance.loggedOutViewerFrameInit();
